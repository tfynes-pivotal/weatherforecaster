...
```json
{
  "applicationName" : "weatherforecaster",
  "projectName" : "weatherforecaster"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'weatherforecaster'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->weatherforecaster]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'weatherforecaster.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->weatherforecaster]
